  ...
  return (
    ...
    <section>
        <div className="lg:px-36 p-4">
            ...
            <p className="my-5 text-sm">Milaap Social Ventures India Pvt. Ltd. Nextcoworks JP Nagar - Coworking Space JP Nagar Alankar Plaza, Bk circle, Nayak Layout, 8th Phase, J. P. Nagar,
            Bangalore, Karnataka, India 560078</p>
            <p className="mb-5 text-sm"> <FiMail className="inline-block mr-2" /> feedback@milaap.org</p>
            <p className="mb-5 text-sm"> <FiPhone className="inline-block mr-2" /> 9916174848</p> 
    ...
    <section>
        <div className="lg:px-36 px-4 py-8 bg-primary lg:py-14">
            ...
            <p className="text-sm">Join us on Facebook, Twitter, Instagram and YouTube as we share uplifting stories of successful fundraisers! </p>
        </div>
    </section>

    <section>
    <div class="lg:px-36 p-4 flex flex-col items-center lg:items-start">
        <p class="lg:py-10 py-4 lg:text-2xl text-lg">Let us know what you think</p>
        <div class="mb-4">
            <input type="text" placeholder="Name" class="border-b border-gray-300 py-4 lg:mr-14 md:mr-14 w-64 lg:w-96"/>
            <input type="email" placeholder="Email Address" class="border-b border-gray-300 py-4 w-64 my-4 lg:w-96"/>
        </div>
        <textarea class="border border-gray-300 rounded-xl p-3 w-full" cols="150" rows="10" placeholder="You can type any suggestions or queries you might have. Let us help you!"></textarea>
        <button class="bg-secondary text-white rounded-3xl my-8 px-28 py-3 lg:self-start">Send</button>
    </div>
    </section>
