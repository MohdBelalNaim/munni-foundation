      ...
      <div>
        <div className="lg:mx-36 relative rounded-xl overflow-hidden border border-gray-200 bg-white my-8 lg:pl-14 px-4 py-4 mx-4">
          <div className="flex justify-end lg:mr-8 absolute right-0">
            <button className="bg-secondary text-white px-8 py-2 mx-4 rounded-full max-sm:hidden">
              EDIT
            </button>
          </div>
        ...
        <div className="lg:mx-36 rounded-xl overflow-hidden border border-gray-200 bg-white my-8 lg:px-14 px-4 py-8 mx-4">
          <div className="flex justify-center xl:flex-row flex-col xl:gap-14">
              ...
              <div className="flex xl:flex-row flex-col">
                <div class="flex justify-center">
                  <img
                    ...
                    alt=""
                    class="w-full sm:w-full md:w-full lg:w-full xl:w-60 xl:h-40"
                  />
                </div>
                <div className="xl:px-4 py-4">
                  ...
                  <p className="py-2 sm:text-xs md:text-sm lg:text-sm">
            ...
            <div className="xl:w-2/5">
              <div class="flex lg:flex-row md:flex-row flex-col justify-center gap-5 pt-4">
                <button class="bg-secondary text-white py-2 lg:text-lg text-sm  rounded-full flex-grow">
                  PERFORMANCE
                </button>
                <button class="bg-secondary text-white py-2 lg:text-lg text-sm rounded-full flex-grow">
                  EDIT
              ...
              <div class="flex justify-center mt-2 mb-6">
                <button class="bg-secondary text-white py-2 lg:text-lg text-sm rounded-full my-2 flex-grow">
                  UPLOAD DOCUMENTS
                </button>
              </div>
          ...
          <div className="flex justify-center mt-8">
            <button className="bg-secondary lg:text-lg text-sm text-white px-14 py-2 rounded-full my-2">
              WITHDRAW FUNDS
            </button>
          </div>
        </div>
